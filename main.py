...
from tkinter import colorchooser, filedialog  # Импортируем модули для выбора цвета и диалогового окна сохранения файла
...
class DrawingApp:
    def __init__(self, root):
        ...
        self.image = Image.new("RGB", (800, 400), "white")  # Создаем новое белое изображение
        self.draw = ImageDraw.Draw(self.image)  # Создаем объект для рисования на изображении

        # Создание холста для рисования
        self.canvas = tk.Canvas(root, width=800, height=400, bg='white')  # Создаем холст с белым фоном
